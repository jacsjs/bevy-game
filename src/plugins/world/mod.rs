...
fn spawn_arena(mut commands: Commands) {
    ...
    spawn_wall("WallTop".into(), Vec3::new(0.0, HALF_H as f32 + thickness * 0.5, 0.0), Vec2::new(HALF_W as f32 * 2.0 + thickness * 2.0, thickness));
    spawn_wall("WallBottom".into(), Vec3::new(0.0, -HALF_H as f32 - thickness * 0.5, 0.0), Vec2::new(HALF_W as f32 * 2.0 + thickness * 2.0, thickness));
    spawn_wall("WallLeft".into(), Vec3::new(-HALF_W as f32 - thickness * 0.5, 0.0, 0.0), Vec2::new(thickness, HALF_H as f32 * 2.0));
    spawn_wall("WallRight".into(), Vec3::new(HALF_W as f32 + thickness * 0.5, 0.0, 0.0), Vec2::new(thickness, HALF_H as f32 * 2.0));
}
